 ...
 <div class="content-wrapper">
   ...
   <section class="content-header">
     <div class="container-fluid">
       <div class="row mb-2">
         <div class="col-sm-6">
           <h1>Certíficados/Primera Comunión</h1>
         </div>
         <div class="col-sm-6">
            ...
            echo '
                        <tr>
                          ...
                          <td>
                            ...
                            <button class="btn btn-success btnPrimeraComunion" data-dismiss="modal" &times;  required data-toggle="tooltip" data-placement="top" title="Imprimir" idPersona = "' . $value["id"] . '">
